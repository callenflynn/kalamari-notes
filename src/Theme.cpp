...
namespace Theme
{
    ...
    void Apply(bool darkMode)
    {
        ...
        if (darkMode)
        {
            ...
            c[ImGuiCol_PopupBg]            = ImVec4(0.14f, 0.14f, 0.14f, 1.0f);
            ...
            c[ImGuiCol_ScrollbarBg]        = ImVec4(0.14f, 0.14f, 0.14f, 0.6f);
            ...
            c[ImGuiCol_Separator]          = ImVec4(0.22f, 0.22f, 0.22f, 1.0f);
            c[ImGuiCol_SeparatorHovered]   = ImVec4(0.40f, 0.40f, 0.40f, 1.0f);
            c[ImGuiCol_SeparatorActive]    = ACCENT_COLOR;
            c[ImGuiCol_Header]             = ImVec4(0.24f, 0.14f, 0.08f, 1.0f);
            c[ImGuiCol_HeaderHovered]      = ImVec4(0.32f, 0.20f, 0.12f, 1.0f);
            c[ImGuiCol_HeaderActive]       = ImVec4(0.40f, 0.26f, 0.15f, 1.0f);
            c[ImGuiCol_Button]             = ACCENT_COLOR;
            c[ImGuiCol_ButtonHovered]      = ACCENT_COLOR_HDR;
            c[ImGuiCol_ButtonActive]       = ImVec4(0.78f, 0.25f, 0.00f, 1.0f);
            ...
            c[ImGuiCol_TabSelected]        = ImVec4(0.20f, 0.20f, 0.20f, 1.0f);
            c[ImGuiCol_TabSelectedOverline] = ACCENT_COLOR;
            c[ImGuiCol_ResizeGrip]         = ImVec4(0.929f, 0.314f, 0.004f, 0.15f);
            c[ImGuiCol_ResizeGripHovered]  = ImVec4(0.929f, 0.314f, 0.004f, 0.45f);
            c[ImGuiCol_ResizeGripActive]   = ImVec4(0.929f, 0.314f, 0.004f, 0.75f);
        ...
        else
        {
            ...
            c[ImGuiCol_TextDisabled]       = ImVec4(0.55f, 0.50f, 0.45f, 1.0f);
            ...
            c[ImGuiCol_ScrollbarBg]        = ImVec4(0.95f, 0.91f, 0.86f, 0.6f);
            ...
            c[ImGuiCol_Separator]          = ImVec4(0.82f, 0.78f, 0.73f, 1.0f);
            ...
            c[ImGuiCol_TabSelectedOverline] = ACCENT_COLOR;
            c[ImGuiCol_ResizeGrip]         = ImVec4(0.929f, 0.314f, 0.004f, 0.12f);
            c[ImGuiCol_ResizeGripHovered]  = ImVec4(0.929f, 0.314f, 0.004f, 0.35f);
            c[ImGuiCol_ResizeGripActive]   = ImVec4(0.929f, 0.314f, 0.004f, 0.60f);
